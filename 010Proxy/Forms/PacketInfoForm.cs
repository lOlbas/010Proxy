...
namespace _010Proxy.Forms
{
    public partial class PacketInfoForm : Form
    {
        ...
        private void scriptInput_TextChanged(object sender, EventArgs e)
        {
        ...
        private void scriptInput_CharAdded(object sender, CharAddedEventArgs e)
        {
            //The '}' char.
            if (e.Char == 125)
            {
        ...
        private void scriptInput_InsertCheck(object sender, InsertCheckEventArgs e)
        {
            if ((e.Text.EndsWith("\n") || e.Text.EndsWith("\r")))
            {
